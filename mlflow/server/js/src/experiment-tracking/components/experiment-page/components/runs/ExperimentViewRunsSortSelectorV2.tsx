...
// bloat that froze the tab on experiments with thousands of metrics.
...
const ExperimentViewRunsSortSelectorV2Body = ({
  ...
  // DropdownMenu items in the DOM at once.
  ...
  return (
    <>
      ...
      <DropdownMenu.Group>
        <div ref={scrollContainerRef} css={{ maxHeight: 400, overflowY: 'auto' }}>
